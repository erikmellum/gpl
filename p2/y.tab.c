...
{
       0,     0,     3,     5,     8,    10,    17,    19,    20,    23,
      25,    27,    31,    33,    37,    39,    43,    45
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      14,     0,    -1,    15,    -1,    15,    16,    -1,    22,    -1,
      10,     4,     5,    17,     6,     8,    -1,    22,    -1,    -1,
      18,    19,    -1,    20,    -1,    21,    -1,    19,     3,     9,
      -1,     9,    -1,    20,     3,    10,    -1,    10,    -1,    21,
       3,    12,    -1,    12,    -1,    -1
};
...
{
       0,   107,   107,   115,   116,   121,   177,   183,   183,   195,
     200,   208,   216,   226,   234,   244,   252,   261
};
#endif
...
{
  "$end", "error", "$undefined", "T_COMMA", "T_ASSIGN", "T_LBRACE",
  "T_RBRACE", "T_INT", "T_SEMIC", "T_INT_CONSTANT", "T_ID", "T_ERROR",
  "T_DOUBLE_CONSTANT", "$accept", "program", "declaration_list",
  "declaration", "values", "$@1", "int_values", "string_values",
  "double_values", "empty", 0
};
#endif
...
{
       0,    13,    14,    15,    15,    16,    16,    18,    17,    17,
      17,    19,    19,    20,    20,    21,    21,    22
};
...
{
      17,     0,     2,     4,     1,     0,     3,     6,     0,     7,
      14,    16,     0,     0,     9,    10,     0,    12,     8,     0,
       0,     5,     0,    13,    15,    11
};
...
{
     -11,     1,    -7,   -11,   -11,     0,   -11,   -11,     2,   -10,
     -11,   -11,    -1,    -3,     5,     6,     3,   -11,     7,     4,
       8,   -11,     9,   -11,   -11,   -11
};
...
{
      10,     4,    11,     5,     8,    16,    17,     9,    19,    20,
      22,    21,     7,     0,    23,     0,     0,     0,    25,     0,
      24
};
...
{
      10,     0,    12,    10,     4,     6,     9,     5,     3,     3,
       3,     8,     2,    -1,    10,    -1,    -1,    -1,     9,    -1,
      12
};
...
{
       0,    14,    15,    22,     0,    10,    16,    22,     4,     5,
      10,    12,    17,    18,    20,    21,     6,     9,    19,     3,
       3,     8,     3,    10,    12,     9
};
...
#line 122 "array.y"
    {
    string id = *(yyvsp[(1) - (6)].union_string); // dereference the string in $1 and copy to local variable id
    ...
    delete (yyvsp[(1) - (6)].union_string);

    cout << id << " = {";

    if ((yyvsp[(4) - (6)].union_variable_type) == INT)
    {
    ...
    delete int_vector;
    int_vector = 0;
    if ((yyvsp[(4) - (6)].union_variable_type) == DOUBLE)
    {
    ...
    if ((yyvsp[(4) - (6)].union_variable_type) == STRING)
    {
...
#line 209 "array.y"
    ...
    int_vector->push_back((yyvsp[(3) - (3)].union_int));
  }
    break;
...
#line 217 "array.y"
    ...
    int_vector->push_back((yyvsp[(1) - (1)].union_int));
  }
    break;
...
#line 227 "array.y"
    ...
    // start of the int_values rule
    // $3 is the union & field associated with T_INT_CONSTANT
    string_vector->push_back(*(yyvsp[(3) - (3)].union_string));
  }
    break;
...
#line 235 "array.y"
    ...
    // same as above
    // code duplication is not idea, but this is easier to understand
    string_vector->push_back(*(yyvsp[(1) - (1)].union_string));
  }
    break;
...
#line 245 "array.y"
    ...
    // start of the int_values rule
    // $3 is the union & field associated with T_INT_CONSTANT
    double_vector->push_back((yyvsp[(3) - (3)].union_double));
  }
    break;
...
#line 253 "array.y"
    ...
    // same as above
    // code duplication is not idea, but this is easier to understand
    double_vector->push_back((yyvsp[(1) - (1)].union_double));
  }
    break;
